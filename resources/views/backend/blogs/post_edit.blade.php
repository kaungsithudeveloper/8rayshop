                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <form id="myForm" method="post" action="{{ route('posts.update') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Name" name="title" autocomplete="name"  value="{{ $post->title }}">
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                <label for="meta_keywords" class="form-label">Post Tags :</label>
                                                <input type="text" name="meta_keywords" class="form-control visually-hidden" data-role="tagsinput" value="{{ $post->meta_keywords }}" >
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-sm-9 text-secondary">
                                                    <img id="showImage" src="{{ (!empty($post->photo))?url('upload/blog_images/'.$post->photo):url('upload/profile.jpg') }}" style="width:200px; height: 120px;" >
                                                </div>
                                            </div>
